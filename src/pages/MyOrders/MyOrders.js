...
const MyOrders = () => {
    ...
    useEffect(() => {
        fetch("https://howling-catacombs-95930.herokuapp.com/usersorders")
            .then(res => res.json())
    ...
    const handleDelete = id => {
        ...
        if (proceed) {
            const url = `https://howling-catacombs-95930.herokuapp.com/usersorders/${id}`;
            fetch(url, {
                method: "DELETE"
            })
                .then(res => res.json())
    ...
    // console.log(myData.service._id)
    return (
        <div>
            ...
            <div className='row mx-auto main'>
                {
                    myData.map(data => <div className='data-card col-md-4 col-sm-12'>
                        ...
                        <div>
                            <p>Selected location : {data.service.SpotName}</p>
